...
import com.example.Apesech.Hotel.Restaurant.dta.RoomDTO;
...
import com.example.Apesech.Hotel.Restaurant.service.LocalFileService;
import com.example.Apesech.Hotel.Restaurant.service.interfaces.IRoomService;
...
public class RoomService implements IRoomService {
    ...
    public Response getAvailableRoomsByDataAndType(LocalDate checkInDate, LocalDate checkOutDate, String roomType) {
        ...
        try {
            List<Room> availableRooms = roomRepository.findAvailableRoomByDateAndType(checkInDate, checkOutDate, roomType);
